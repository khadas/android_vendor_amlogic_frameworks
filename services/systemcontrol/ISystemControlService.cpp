...
public:
    ...
    //PQ
    virtual int loadPQSettings(source_input_param_t source_input_param)
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());
        data.writeInt32((int)source_input_param.source_input);
        data.writeInt32((int)source_input_param.source_type);
        data.writeInt32((int)source_input_param.source_port);
        data.writeInt32((int)source_input_param.sig_fmt);
        data.writeInt32((int)source_input_param.is3d);
        data.writeInt32((int)source_input_param.trans_fmt);

        if (remote()->transact(LOAD_PQSETTING, data, &reply) != NO_ERROR) {
            ALOGE("loadPQSettings could not contact remote\n");
            return -1;
        }

        int32_t err = reply.readInt32();
        if (err < 0) {
            ALOGE("loadPQSettings caught exception\n");
            return -1;
        }
        return 0;
    }

    virtual int loadCpqLdimRegs(void)
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());
        if (remote()->transact(LOAD_LDIM, data, &reply) != NO_ERROR) {
            ALOGE("loadCpqLdimRegs could not contact remote\n");
            return -1;
        }

        int32_t err = reply.readInt32();
        if (err < 0) {
            ALOGE("loadCpqLdimRegs caught exception\n");
            return -1;
        }
        return 0;
    }

    virtual int setPQmode(int pq_mode, int is_save, int is_autoswitch)
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());
        data.writeInt32(pq_mode);
        data.writeInt32(is_save);
        data.writeInt32(is_autoswitch);

        if (remote()->transact(SET_PQMODE, data, &reply) != NO_ERROR) {
            ALOGE("setPQmode could not contact remote\n");
            return -1;
        }

        int32_t err = reply.readInt32();
        if (err < 0) {
            ALOGE("setPQmode caught exception\n");
            return -1;
        }
        return 0;
    }
    virtual int getPQmode(void)
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());

        if (remote()->transact(GET_PQMODE, data, &reply) != NO_ERROR) {
            ALOGE("getPQmode could not contact remote\n");
            return -1;
        }

        int32_t value = reply.readInt32();
        if (value < 0) {
            ALOGE("getPQmode caught exception\n");
            return -1;
        }
    ...
    virtual int savePQmode(int pq_mode)
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());
        data.writeInt32(pq_mode);

        if (remote()->transact(SAVE_PQMODE, data, &reply) != NO_ERROR) {
            ALOGE("savePQmode could not contact remote\n");
            return -1;
        }

        int32_t err = reply.readInt32();
        if (err < 0) {
            ALOGE("savePQmode caught exception\n");
            return -1;
        }
    ...
    virtual int setColorTemperature(int temp_mode, int is_save)
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());
        data.writeInt32(temp_mode);
        data.writeInt32(is_save);

        if (remote()->transact(SET_COLORTEMPERATURE, data, &reply) != NO_ERROR) {
            ALOGE("setColorTemperature could not contact remote\n");
            return -1;
        }

        int32_t err = reply.readInt32();
        if (err < 0) {
            ALOGE("setColorTemperature caught exception\n");
            return -1;
        }

        return 0;
    }
    virtual int getColorTemperature(void)
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());

        if (remote()->transact(GET_COLORTEMPERATURE, data, &reply) != NO_ERROR) {
            ALOGE("getColorTemperature could not contact remote\n");
            return -1;
        }

        int32_t value = reply.readInt32();
        if (value < 0) {
            ALOGE("getColorTemperature caught exception\n");
            return -1;
        }

        return value;
    }
    virtual int saveColorTemperature(int temp_mode)
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());
        data.writeInt32(temp_mode);

        if (remote()->transact(SAVE_COLORTEMPERATURE, data, &reply) != NO_ERROR) {
            ALOGE("saveColorTemperature could not contact remote\n");
            return -1;
        }

        int32_t err = reply.readInt32();
        if (err < 0) {
            ALOGE("saveColorTemperature caught exception\n");
            return -1;
        }

        return 0;
    }
    virtual int setColorTemperatureParam(int Tempmode, tcon_rgb_ogo_t params)
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());
        data.writeInt32(Tempmode);
        data.writeInt32(params.en);
        data.writeInt32(params.r_post_offset);
        data.writeInt32(params.g_post_offset);
        data.writeInt32(params.b_post_offset);
        data.writeInt32(params.r_gain);
        data.writeInt32(params.g_gain);
        data.writeInt32(params.b_gain);
        data.writeInt32(params.r_pre_offset);
        data.writeInt32(params.g_pre_offset);
        data.writeInt32(params.b_pre_offset);

        if (remote()->transact(SET_COLORTEMPERATUREPARAM, data, &reply) != NO_ERROR) {
            ALOGE("setColorTemperatureParam could not contact remote\n");
            return -1;
        }

        int32_t err = reply.readInt32();
        if (err < 0) {
            ALOGE("setColorTemperatureParam caught exception\n");
            return -1;
        }
    ...
    virtual int getColorTemperatureParam(int Tempmode, int id)
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());
        data.writeInt32(Tempmode);
        ...
        if (remote()->transact(GET_COLORTEMPERATUREPARAM, data, &reply) != NO_ERROR) {
            ALOGE("setColorTemperatureParam could not contact remote\n");
            return -1;
        }
    ...
    virtual int saveColorTemperatureParam(int Tempmode, tcon_rgb_ogo_t params)
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());
        data.writeInt32(Tempmode);
        ...
        if (remote()->transact(SAVE_COLORTEMPERATUREPARAM, data, &reply) != NO_ERROR) {
            ALOGE("setColorTemperatureParam could not contact remote\n");
            return -1;
        }
    ...
    virtual int setBrightness(int value, int is_save)
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());
        ...
        if (remote()->transact(SET_BRIGHTNESS, data, &reply) != NO_ERROR) {
            ALOGE("SetBrightness could not contact remote\n");
            return -1;
        }

        int32_t err = reply.readInt32();
        if (err < 0) {
            ALOGE("SetBrightness caught exception\n");
            return -1;
        }
    ...
    virtual int getBrightness(void)
    {
        ...
        if (remote()->transact(GET_BRIGHTNESS, data, &reply) != NO_ERROR) {
            ALOGE("getBrightness could not contact remote\n");
            return -1;
        }

        int32_t value = reply.readInt32();
        if (value < 0) {
            ALOGE("getBrightness caught exception\n");
            return -1;
        }

        return value;
    }
    virtual int saveBrightness(int value)
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());
        data.writeInt32(value);

        if (remote()->transact(SAVE_BRIGHTNESS, data, &reply) != NO_ERROR) {
            ALOGE("saveBrightness could not contact remote\n");
            return -1;
        }

        int32_t err = reply.readInt32();
        if (err < 0) {
            ALOGE("saveBrightness caught exception\n");
            return -1;
        }

        return 0;
    }
    virtual int setContrast(int value, int is_save )
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());
        data.writeInt32(value);
        ...
        if (remote()->transact(SET_CONTRAST, data, &reply) != NO_ERROR) {
            ALOGE("setContrast could not contact remote\n");
            return -1;
        }

        int32_t err = reply.readInt32();
        if (err < 0) {
            ALOGE("setContrast caught exception\n");
            return -1;
        }
    ...
    virtual int getContrast(void)
    {
        ...
        if (remote()->transact(GET_CONTRAST, data, &reply) != NO_ERROR) {
            ALOGE("getContrast could not contact remote\n");
            return -1;
        }

        int32_t value = reply.readInt32();
        if (value < 0) {
            ALOGE("getContrast caught exception\n");
            return -1;
        }

        return value;
    }
    virtual int saveContrast(int value)
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());
        data.writeInt32(value);

        if (remote()->transact(SAVE_CONTRAST, data, &reply) != NO_ERROR) {
            ALOGE("saveContrast could not contact remote\n");
            return -1;
        }

        int32_t err = reply.readInt32();
        if (err < 0) {
            ALOGE("saveContrast caught exception\n");
            return -1;
        }

        return 0;
    }
    virtual int setSaturation(int value, int is_save)
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());
        data.writeInt32(value);
        ...
        if (remote()->transact(SET_SATURATION, data, &reply) != NO_ERROR) {
            ALOGE("setSaturation could not contact remote\n");
            return -1;
        }

        int32_t err = reply.readInt32();
        if (err < 0) {
            ALOGE("setSaturation caught exception\n");
            return -1;
        }
    ...
    virtual int getSaturation(void)
    {
        ...
        if (remote()->transact(GET_SATURATION, data, &reply) != NO_ERROR) {
            ALOGE("getSaturation could not contact remote\n");
            return -1;
        }

        int32_t value = reply.readInt32();
        if (value < 0) {
            ALOGE("getSaturation caught exception\n");
            return -1;
        }

        return value;
    }
    virtual int saveSaturation(int value)
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());
        data.writeInt32(value);

        if (remote()->transact(SAVE_SATURATION, data, &reply) != NO_ERROR) {
            ALOGE("saveSaturation could not contact remote\n");
            return -1;
        }

        int32_t err = reply.readInt32();
        if (err < 0) {
            ALOGE("saveSaturation caught exception\n");
            return -1;
        }
    ...
    virtual int setHue(int value, int is_save)
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());
        data.writeInt32(value);
        ...
        if (remote()->transact(SET_HUE, data, &reply) != NO_ERROR) {
            ALOGE("setHue could not contact remote\n");
            return -1;
        }

        int32_t err = reply.readInt32();
        if (err < 0) {
            ALOGE("setHue caught exception\n");
            return -1;
        }
    ...
    virtual int getHue(void)
    {
        ...
        if (remote()->transact(GET_HUE, data, &reply) != NO_ERROR) {
            ALOGE("getHue could not contact remote\n");
            return -1;
        }

        int32_t value = reply.readInt32();
        if (value < 0) {
            ALOGE("getHue caught exception\n");
            return -1;
        }

        return value;
    }
    virtual int saveHue(int value)
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());
        data.writeInt32(value);

        if (remote()->transact(SAVE_HUE, data, &reply) != NO_ERROR) {
            ALOGE("saveHue could not contact remote\n");
            return -1;
        }

        int32_t err = reply.readInt32();
        if (err < 0) {
            ALOGE("saveHue caught exception\n");
            return -1;
        }

        return 0;
    }
    virtual int setSharpness(int value, int is_enable, int is_save)
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());
        data.writeInt32(value);
        data.writeInt32(is_enable);
        data.writeInt32(is_save);

        if (remote()->transact(SET_SHARPNESS, data, &reply) != NO_ERROR) {
            ALOGE("setSharpness could not contact remote\n");
            return -1;
        }

        int32_t err = reply.readInt32();
        if (err < 0) {
            ALOGE("setSharpness caught exception\n");
            return -1;
        }
    ...
    virtual int getSharpness(void)
    {
        ...
        if (remote()->transact(GET_SHARPNESS, data, &reply) != NO_ERROR) {
            ALOGE("getSharpness could not contact remote\n");
            return -1;
        }

        int32_t value = reply.readInt32();
        if (value < 0) {
            ALOGE("getSharpness caught exception\n");
            return -1;
        }

        return value;
    }
    virtual int saveSharpness(int value)
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());
        data.writeInt32(value);

        if (remote()->transact(SAVE_SHARPNESS, data, &reply) != NO_ERROR) {
            ALOGE("saveSharpness could not contact remote\n");
            return -1;
        }

        int32_t err = reply.readInt32();
        if (err < 0) {
            ALOGE("saveSharpness caught exception\n");
            return -1;
        }

        return 0;
    }
    virtual int setNoiseReductionMode(int nr_mode, int is_save)
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());
        data.writeInt32(nr_mode);
        data.writeInt32(is_save);

        if (remote()->transact(SET_NOISEREDUCTIONMODE, data, &reply) != NO_ERROR) {
            ALOGE("setNoiseReductionMode could not contact remote\n");
            return -1;
        }

        int32_t err = reply.readInt32();
        if (err < 0) {
            ALOGE("setNoiseReductionMode caught exception\n");
            return -1;
        }

        return 0;
    }
    virtual int getNoiseReductionMode(void)
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());

        if (remote()->transact(GET_NOISEREDUCTIONMODE, data, &reply) != NO_ERROR) {
            ALOGE("getNoiseReductionMode could not contact remote\n");
            return -1;
        }

        int32_t value = reply.readInt32();
        if (value < 0) {
            ALOGE("getNoiseReductionMode caught exception\n");
            return -1;
        }

        return value;
    }
    virtual int saveNoiseReductionMode(int nr_mode)
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());
        data.writeInt32(nr_mode);

        if (remote()->transact(SAVE_NOISEREDUCTIONMODE, data, &reply) != NO_ERROR) {
            ALOGE("saveNoiseReductionMode could not contact remote\n");
            return -1;
        }

        int32_t err = reply.readInt32();
        if (err < 0) {
            ALOGE("saveNoiseReductionMode caught exception\n");
            return -1;
        }
    ...
    virtual int setGammaValue(int gamma_curve, int is_save)
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());
        data.writeInt32(gamma_curve);
        data.writeInt32(is_save);

        if (remote()->transact(SET_GAMMAVALUE, data, &reply) != NO_ERROR) {
            ALOGE("setGammaValue could not contact remote\n");
            return -1;
        }

        int32_t err = reply.readInt32();
        if (err < 0) {
            ALOGE("setGammaValue caught exception\n");
            return -1;
        }
    ...
    virtual int getGammaValue(void)
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());

        if (remote()->transact(GET_GAMMAVALUE, data, &reply) != NO_ERROR) {
            ALOGE("getGammaValue could not contact remote\n");
            return -1;
        }

        int32_t value = reply.readInt32();
        if (value < 0) {
            ALOGE("getGammaValue caught exception\n");
            return -1;
        }
    ...
    virtual int factoryResetPQMode(void)
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());

        if (remote()->transact(FACTORY_RESET_PQMODE, data, &reply) != NO_ERROR) {
            ALOGE("factoryResetPQMode could not contact remote\n");
            return -1;
        }

        int32_t err = reply.readInt32();
        if (err < 0) {
            ALOGE("factoryResetPQMode caught exception\n");
            return -1;
        }
    ...
    virtual int factoryResetColorTemp(void)
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());

        if (remote()->transact(FACTORY_RESET_COLORTEMP, data, &reply) != NO_ERROR) {
            ALOGE("factoryResetColorTemp could not contact remote\n");
            return -1;
        }

        int32_t err = reply.readInt32();
        if (err < 0) {
            ALOGE("factoryResetColorTemp caught exception\n");
            return -1;
        }
    ...
    virtual int factorySetPQParam(source_input_param_t source_input_param, int pq_mode, int id, int value)
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());
        data.writeInt32((int)source_input_param.source_input);
        ...
        if (remote()->transact(FACTORY_SET_PQPARAM, data, &reply) != NO_ERROR) {
            ALOGE("factorySetPQParam could not contact remote\n");
            return -1;
        }

        int32_t err = reply.readInt32();
        if (err < 0) {
            ALOGE("factorySetPQParam caught exception\n");
            return -1;
        }
    ...
    virtual int factoryGetPQParam(source_input_param_t source_input_param, int pq_mode, int id)
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());
        data.writeInt32((int)source_input_param.source_input);
        ...
        if (remote()->transact(FACTORY_GET_PQPARAM, data, &reply) != NO_ERROR) {
            ALOGE("factoryGetPQParam could not contact remote\n");
            return -1;
        }

        int32_t value = reply.readInt32();
        if (value < 0) {
            ALOGE("factoryGetPQParam caught exception\n");
            return -1;
        }
    ...
    virtual int factorySetColorTemperatureParam(int colortemperature_mode, int id, int value)
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());
        data.writeInt32(colortemperature_mode);
        data.writeInt32(id);
        data.writeInt32(value);

        if (remote()->transact(FACTORY_SET_COLORTEMPPARAM, data, &reply) != NO_ERROR) {
            ALOGE("factorySetColorTemperatureParam could not contact remote\n");
            return -1;
        }

        int32_t err = reply.readInt32();
        if (err < 0) {
            ALOGE("factorySetColorTemperatureParam caught exception\n");
            return -1;
        }
    ...
    virtual int factoryGetColorTemperatureParam(int colortemperature_mode, int id)
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());
        data.writeInt32(colortemperature_mode);
        ...
        if (remote()->transact(FACTORY_GET_COLORTEMPPARAM, data, &reply) != NO_ERROR) {
            ALOGE("factoryGetColorTemperatureParam could not contact remote\n");
            return -1;
        }

        int32_t value = reply.readInt32();
        if (value < 0) {
            ALOGE("factoryGetColorTemperatureParam caught exception\n");
            return -1;
        }
    ...
    virtual int factorySaveColorTemperatureParam(int colortemperature_mode, int id, int value)
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());
        data.writeInt32(colortemperature_mode);
        ...
        if (remote()->transact(FACTORY_SAVE_COLORTEMPPARAM, data, &reply) != NO_ERROR) {
            ALOGE("factorySaveColorTemperatureParam could not contact remote\n");
            return -1;
        }

        int32_t err = reply.readInt32();
        if (err < 0) {
            ALOGE("factorySaveColorTemperatureParam caught exception\n");
            return -1;
        }
    ...
    virtual int factorySetOverscan(source_input_param_t source_input_param, int he_value, int hs_value, int ve_value, int vs_value )
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());
        data.writeInt32((int)source_input_param.source_input);
        ...
        data.writeInt32((int)source_input_param.is3d);
        data.writeInt32((int)source_input_param.trans_fmt);
        data.writeInt32(he_value);
        data.writeInt32(hs_value);
        data.writeInt32(ve_value);
        data.writeInt32(vs_value);

        if (remote()->transact(FACTORY_SET_OVERSCAN, data, &reply) != NO_ERROR) {
            ALOGE("factorySetOverscan could not contact remote\n");
            return -1;
        }

        int32_t err = reply.readInt32();
        if (err < 0) {
            ALOGE("factorySetOverscan caught exception\n");
            return -1;
        }
    ...
    virtual int factoryGetOverscan(source_input_param_t source_input_param, int id)
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());
        data.writeInt32((int)source_input_param.source_input);
        ...
        if (remote()->transact(FACTORY_GET_OVERSCAN, data, &reply) != NO_ERROR) {
            ALOGE("factoryGetOverscan could not contact remote\n");
            return -1;
        }

        int32_t value = reply.readInt32();
        if (value < 0) {
            ALOGE("factoryGetOverscan caught exception\n");
            return -1;
        }
    ...
    virtual int factorySetNolineParams(source_input_param_t source_input_param, int type, int osd0_value, int osd25_value,
...

    {
        ...
        data.writeInt32(osd0_value);
        data.writeInt32(osd25_value);
        data.writeInt32(osd50_value);
        data.writeInt32(osd75_value);
        data.writeInt32(osd100_value);
        if (remote()->transact(FACTORY_SET_NOLINEPARAMS, data, &reply) != NO_ERROR) {
            ALOGE("factorySetNolineParams could not contact remote\n");
            return -1;
        }

        int32_t err = reply.readInt32();
        if (err < 0) {
            ALOGE("factorySetNolineParams caught exception\n");
            return -1;
        }

        return -1;
    }
    virtual int factoryGetNolineParams(source_input_param_t source_input_param, int type, int id)
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());
        data.writeInt32((int)source_input_param.source_input);
        ...
        data.writeInt32(type);
        data.writeInt32(id);
        if (remote()->transact(FACTORY_GET_NOLINEPARAMS, data, &reply) != NO_ERROR) {
            ALOGE("factoryGetNolineParams could not contact remote\n");
            return -1;
        }

        int32_t value = reply.readInt32();
        if (value < 0) {
            ALOGE("factoryGetNolineParams caught exception\n");
            return -1;
        }
    ...
    virtual int factorySetParamsDefault(void)
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());
        if (remote()->transact(FACTORY_RSET_PARAMS, data, &reply) != NO_ERROR) {
            ALOGE("factorySetParamsDefault could not contact remote\n");
            return -1;
        }

        int32_t err = reply.readInt32();
        if (err < 0) {
            ALOGE("factorySetParamsDefault caught exception\n");
            return -1;
        }
    ...
    virtual int factorySSMRestore(void)
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());
        if (remote()->transact(FACTORY_SSM_RESTORE, data, &reply) != NO_ERROR) {
            ALOGE("factorySSMRestore could not contact remote\n");
            return -1;
        }

        int32_t err = reply.readInt32();
        if (err < 0) {
            ALOGE("factorySSMRestore caught exception\n");
            return -1;
        }
    ...
    virtual int factoryResetNonlinear(void)
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());
        if (remote()->transact(FACTORY_RESET_NOLINEAR, data, &reply) != NO_ERROR) {
            ALOGE("factoryResetNonlinear could not contact remote\n");
            return -1;
        }

        int32_t err = reply.readInt32();
        if (err < 0) {
            ALOGE("factoryResetNonlinear caught exception\n");
            return -1;
        }
    ...
    virtual int factorySetGamma(int gamma_r, int gamma_g, int gamma_b)
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());
        data.writeInt32(gamma_r);
        data.writeInt32(gamma_g);
        data.writeInt32(gamma_b);

        if (remote()->transact(FACTORY_SET_GAMMA, data, &reply) != NO_ERROR) {
            ALOGE("factorySetGamma could not contact remote\n");
            return -1;
        }

        int32_t err = reply.readInt32();
        if (err < 0) {
            ALOGE("factorySetGamma caught exception\n");
            return -1;
        }
    ...
    virtual int sysSSMReadNTypes(int id, int data_len, int offset)
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());
        data.writeInt32(id);
        data.writeInt32(data_len);
        data.writeInt32(offset);

        if (remote()->transact(SSMREADNTYPES, data, &reply) != NO_ERROR) {
            ALOGE("sysSSMReadNTypes could not contact remote\n");
            return -1;
        }

        int32_t value = reply.readInt32();
        if (value < 0) {
            ALOGE("sysSSMReadNTypes caught exception\n");
            return -1;
        }
    ...
    virtual int sysSSMWriteNTypes(int id, int data_len,int data_buf, int offset)
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());
        data.writeInt32(id);
        data.writeInt32(data_len);
        data.writeInt32(data_buf);
        data.writeInt32(offset);

        if (remote()->transact(SSMWRITENTYPES, data, &reply) != NO_ERROR) {
            ALOGE("sysSSMWriteNTypes could not contact remote\n");
            return -1;
        }

        int32_t err = reply.readInt32();
        if (err < 0) {
            ALOGE("sysSSMWriteNTypes caught exception\n");
            return -1;
        }
    ...
    virtual int getActualAddr(int id)
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());
        data.writeInt32(id);

        if (remote()->transact(SSM_GET_ADDR, data, &reply) != NO_ERROR) {
            ALOGE("getActualAddr could not contact remote\n");
            return -1;
        }

        int32_t value = reply.readInt32();
        if (value < 0) {
            ALOGE("getActualAddr caught exception\n");
            return -1;
        }
    ...
    virtual int getActualSize(int id)
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());
        data.writeInt32(id);

        if (remote()->transact(SSM_GET_SIZE, data, &reply) != NO_ERROR) {
            ALOGE("getActualAddr could not contact remote\n");
            return -1;
        }
    ...
    virtual int SSMRecovery(void)
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());

        if (remote()->transact(SSM_RECOVERY, data, &reply) != NO_ERROR) {
            ALOGE("SSMRecovery could not contact remote\n");
            return -1;
        }

        int32_t err = reply.readInt32();
        if (err < 0) {
            ALOGE("SSMRecovery caught exception\n");
            return -1;
        }
    ...
    virtual int setPLLValues(source_input_param_t source_input_param)
    {
        ...
        if (remote()->transact(SET_PLLVALUES, data, &reply) != NO_ERROR) {
            ALOGE("setPLLValues could not contact remote\n");
            return -1;
        }

        int32_t err = reply.readInt32();
        if (err < 0) {
            ALOGE("setPLLValues caught exception\n");
            return -1;
        }
    ...
    virtual int setCVD2Values(source_input_param_t source_input_param)
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());
        data.writeInt32((int)source_input_param.source_input);
        ...
        if (remote()->transact(SET_CVD2VALUES, data, &reply) != NO_ERROR) {
            ALOGE("setCVD2Values could not contact remote\n");
            return -1;
        }

        int32_t err = reply.readInt32();
        if (err < 0) {
            ALOGE("setCVD2Values caught exception\n");
            return -1;
        }
    ...
    virtual int setPQConfig(Set_Flag_Cmd_t id, int value)
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());
        data.writeInt32((int)id);
        data.writeInt32(value);

        if (remote()->transact(SET_PQ_CONFIG, data, &reply) != NO_ERROR) {
            ALOGE("setPQConfig could not contact remote\n");
            return -1;
        }

        int32_t err = reply.readInt32();
        if (err < 0) {
            ALOGE("setPQConfig caught exception\n");
            return -1;
        }
    ...
    virtual int getSSMStatus(void)
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());

        if (remote()->transact(GET_SSM_STATUS, data, &reply) != NO_ERROR) {
            ALOGE("getSSMStatus could not contact remote\n");
            return -1;
        }

        int32_t value = reply.readInt32();
        if (value < 0) {
            ALOGE("getSSMStatus caught exception\n");
            return -1;
        }
    ...
    virtual int resetLastPQSettingsSourceType(void)
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());

        if (remote()->transact(RESET_LAST_SOURCE, data, &reply) != NO_ERROR) {
            ALOGE("resetLastPQSettingsSourceType could not contact remote\n");
            return -1;
        }

        int32_t err = reply.readInt32();
        if (err < 0) {
            ALOGE("resetLastPQSettingsSourceType caught exception\n");
            return -1;
        }
    ...
    virtual int setCurrentSourceInfo(source_input_param_t source_input_param)
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());
        data.writeInt32((int)source_input_param.source_input);
        ...
        if (remote()->transact(SET_CUR_SOURCE_INFO, data, &reply) != NO_ERROR) {
            ALOGE("setCurrentSourceInfo could not contact remote\n");
            return -1;
        }

        int32_t err = reply.readInt32();
        if (err < 0) {
            ALOGE("setCurrentSourceInfo caught exception\n");
            return -1;
        }
    ...
    virtual int getAutoSwitchPCModeFlag(void)
    {
        Parcel data, reply;
        data.writeInterfaceToken(ISystemControlService::getInterfaceDescriptor());
        if (remote()->transact(GET_AUTOSWITCHPCMODEFLAG, data, &reply) != NO_ERROR) {
            ALOGE("getAutoSwitchPCModeFlag could not contact remote\n");
            return -1;
        }

        int32_t value = reply.readInt32();
        if (value < 0) {
            ALOGE("getAutoSwitchPCModeFlag caught exception\n");
            return -1;
        }
    ...
    uint32_t code, const Parcel& data, Parcel* reply, uint32_t flags)
{
    switch(code) {
        ...
        case LOAD_PQSETTING: {
            ...
            source_input_param.source_input = (tv_source_input_t)data.readInt32();
            source_input_param.source_type = (tv_source_input_type_t)data.readInt32();
            source_input_param.source_port = (tvin_port_t)data.readInt32();
            source_input_param.sig_fmt = (tvin_sig_fmt_t)data.readInt32();
            source_input_param.is3d = (is_3d_type_t)data.readInt32();
            source_input_param.trans_fmt = (tvin_trans_fmt_t)data.readInt32();
            int result = loadPQSettings(source_input_param);
            reply->writeInt32(result);
            return NO_ERROR;
        }
        case LOAD_LDIM: {
            CHECK_INTERFACE(ISystemControlService, data, reply);
            int result = loadCpqLdimRegs();
            reply->writeInt32(result);
            return NO_ERROR;
        }
        case SET_PQMODE: {
            CHECK_INTERFACE(ISystemControlService, data, reply);
            int pq_mode = data.readInt32();
            int is_save = data.readInt32();
            int is_autoswitch = data.readInt32();
            int result = setPQmode(pq_mode, is_save, is_autoswitch);
            reply->writeInt32(result);
            return NO_ERROR;
        }
        case GET_PQMODE: {
            CHECK_INTERFACE(ISystemControlService, data, reply);
            int result = getPQmode();
            reply->writeInt32(result);
            return NO_ERROR;
        }
        case SAVE_PQMODE: {
            CHECK_INTERFACE(ISystemControlService, data, reply);
            int pq_mode =  data.readInt32();
            int result = savePQmode(pq_mode);
            reply->writeInt32(result);
            return NO_ERROR;
        }
        case SET_COLORTEMPERATURE: {
            CHECK_INTERFACE(ISystemControlService, data, reply);
            int temp_mode = data.readInt32();
            int is_save = data.readInt32();
            int result = setColorTemperature(temp_mode, is_save);
            reply->writeInt32(result);
            return NO_ERROR;
        }
        case GET_COLORTEMPERATURE: {
            CHECK_INTERFACE(ISystemControlService, data, reply);
            int result = getColorTemperature();
            reply->writeInt32((int)result);
            return NO_ERROR;
        }
        case SAVE_COLORTEMPERATURE: {
            CHECK_INTERFACE(ISystemControlService, data, reply);
            int temp_mode = data.readInt32();
            int result = saveColorTemperature(temp_mode);
            reply->writeInt32(result);
            return NO_ERROR;
        }
        case SET_COLORTEMPERATUREPARAM: {
            CHECK_INTERFACE(ISystemControlService, data, reply);
            tcon_rgb_ogo_t params;
            int Tempmode = data.readInt32();
            ...
            int result = setColorTemperatureParam(Tempmode, params);
            reply->writeInt32(result);
            return NO_ERROR;
        }
        case GET_COLORTEMPERATUREPARAM: {
            CHECK_INTERFACE(ISystemControlService, data, reply);
            int Tempmode = data.readInt32();
            int id = data.readInt32();
            int result = getColorTemperatureParam(Tempmode, id);
            reply->writeInt32(result);
            return NO_ERROR;
        }
        case SAVE_COLORTEMPERATUREPARAM: {
            CHECK_INTERFACE(ISystemControlService, data, reply);
            tcon_rgb_ogo_t params;
            int Tempmode = data.readInt32();
            params.en = data.readInt32();
            ...
            params.g_pre_offset = data.readInt32();
            params.b_pre_offset = data.readInt32();
            int result = saveColorTemperatureParam(Tempmode, params);
            reply->writeInt32(result);
            return NO_ERROR;
        }
        case SET_BRIGHTNESS: {
            ...
            int is_save = data.readInt32();
            int result = setBrightness(value, is_save);
            reply->writeInt32(result);
            return NO_ERROR;
        }
        case GET_BRIGHTNESS: {
            CHECK_INTERFACE(ISystemControlService, data, reply);
            int result = getBrightness();
            reply->writeInt32(result);
            return NO_ERROR;
        }
        case SAVE_BRIGHTNESS: {
            CHECK_INTERFACE(ISystemControlService, data, reply);
            int value = data.readInt32();
            int result = saveBrightness(value);
            reply->writeInt32(result);
            return NO_ERROR;
        }
        case SET_CONTRAST: {
            ...
            int value = data.readInt32();
            int is_save = data.readInt32();
            int result = setContrast(value, is_save);
            reply->writeInt32(result);
            return NO_ERROR;;
        }
        case GET_CONTRAST: {
            CHECK_INTERFACE(ISystemControlService, data, reply);
            int result = getContrast();
            reply->writeInt32(result);
            return NO_ERROR;
        }
        case SAVE_CONTRAST: {
        ...
        case SET_SATURATION: {
            ...
            int value = data.readInt32();
            int is_save = data.readInt32();
            int result = setSaturation(value, is_save);
            reply->writeInt32(result);
            return NO_ERROR;
        }
        case GET_SATURATION: {
            CHECK_INTERFACE(ISystemControlService, data, reply);
            int result = getSaturation();
            reply->writeInt32(result);
            return NO_ERROR;
        }
        case SAVE_SATURATION: {
            CHECK_INTERFACE(ISystemControlService, data, reply);
            int value = data.readInt32();
            int result = saveSaturation(value);
            return NO_ERROR;
        }
        case SET_HUE: {
            CHECK_INTERFACE(ISystemControlService, data, reply);
            int value = data.readInt32();
            int is_save = data.readInt32();
            int result = setHue(value, is_save);
            reply->writeInt32(result);
            return NO_ERROR;
        }
        case GET_HUE: {
        ...
        case SET_SHARPNESS: {
            CHECK_INTERFACE(ISystemControlService, data, reply);
            int value = data.readInt32();
            int is_enable = data.readInt32();
            int is_save = data.readInt32();
            int result = setSharpness(value, is_enable, is_save);
            reply->writeInt32(result);
            return NO_ERROR;
        }
        case GET_SHARPNESS: {
            CHECK_INTERFACE(ISystemControlService, data, reply);
            int result = getSharpness();
            reply->writeInt32(result);
            return NO_ERROR;
        }
        case SAVE_SHARPNESS: {
            CHECK_INTERFACE(ISystemControlService, data, reply);
            int value = data.readInt32();
            int result = saveSharpness(value);
            reply->writeInt32(result);
            return NO_ERROR;
        }
        case SET_NOISEREDUCTIONMODE: {
            CHECK_INTERFACE(ISystemControlService, data, reply);
            int nr_mode = data.readInt32();
            int is_save = data.readInt32();
            int result = setNoiseReductionMode(nr_mode, is_save);
            reply->writeInt32(result);
            return NO_ERROR;
        }
        case GET_NOISEREDUCTIONMODE: {
            CHECK_INTERFACE(ISystemControlService, data, reply);
            int result = getNoiseReductionMode();
            reply->writeInt32(result);
            return NO_ERROR;
        }
        case SAVE_NOISEREDUCTIONMODE: {
            CHECK_INTERFACE(ISystemControlService, data, reply);
            int nr_mode = data.readInt32();
            int result = saveNoiseReductionMode(nr_mode);
            reply->writeInt32(result);
            return NO_ERROR;
        }
        case SET_GAMMAVALUE: {
            CHECK_INTERFACE(ISystemControlService, data, reply);
            int gamma_curve = data.readInt32();
            int is_save = data.readInt32();
            int result = setGammaValue(gamma_curve, is_save);
            reply->writeInt32(result);
            return NO_ERROR;
        }
        case GET_GAMMAVALUE: {
            CHECK_INTERFACE(ISystemControlService, data, reply);
            int result = getGammaValue();
            reply->writeInt32(result);
            return NO_ERROR;
        }
        case FACTORY_RESET_PQMODE: {
            CHECK_INTERFACE(ISystemControlService, data, reply);
            int result = factoryResetPQMode();
            reply->writeInt32(result);
            return NO_ERROR;
        }
        case FACTORY_RESET_COLORTEMP: {
            CHECK_INTERFACE(ISystemControlService, data, reply);
            int result = factoryResetColorTemp();
            reply->writeInt32(result);
            return NO_ERROR;
        }
        case FACTORY_SET_PQPARAM: {
            CHECK_INTERFACE(ISystemControlService, data, reply);
            source_input_param_t source_input_param;
            source_input_param.source_input = (tv_source_input_t)data.readInt32();
            source_input_param.source_type = (tv_source_input_type_t)data.readInt32();
            ...
            int id = data.readInt32();
            int value = data.readInt32();
            int result = factorySetPQParam(source_input_param, pq_mode, id, value);
            reply->writeInt32(result);
            return NO_ERROR;
        }
        case FACTORY_GET_PQPARAM: {
            CHECK_INTERFACE(ISystemControlService, data, reply);
            source_input_param_t source_input_param;
            source_input_param.source_input = (tv_source_input_t)data.readInt32();
            source_input_param.source_type = (tv_source_input_type_t)data.readInt32();
            ...
            int pq_mode = data.readInt32();
            int id = data.readInt32();
            int result = factoryGetPQParam(source_input_param, pq_mode, id);
            reply->writeInt32(result);
            return NO_ERROR;
        }
        case FACTORY_SET_COLORTEMPPARAM: {
            CHECK_INTERFACE(ISystemControlService, data, reply);
            int colortemperature_mode = data.readInt32();
            int id = data.readInt32();
            int value = data.readInt32();
            int result = factorySetColorTemperatureParam(colortemperature_mode, id, value);
            reply->writeInt32(result);
            return NO_ERROR;
        }
        case FACTORY_GET_COLORTEMPPARAM: {
            CHECK_INTERFACE(ISystemControlService, data, reply);
            int colortemperature_mode = data.readInt32();
            int id = data.readInt32();
            int result = factoryGetColorTemperatureParam(colortemperature_mode, id);
            reply->writeInt32(result);
            return NO_ERROR;
        }
        case FACTORY_SAVE_COLORTEMPPARAM: {
            CHECK_INTERFACE(ISystemControlService, data, reply);
            int colortemperature_mode = data.readInt32();
            int id = data.readInt32();
            int value = data.readInt32();
            int result = factorySaveColorTemperatureParam(colortemperature_mode, id, value);
            reply->writeInt32(result);
            return NO_ERROR;
        }
        case FACTORY_SET_OVERSCAN: {
            CHECK_INTERFACE(ISystemControlService, data, reply);
            source_input_param_t source_input_param;
            ...
            source_input_param.is3d = (is_3d_type_t)data.readInt32();
            source_input_param.trans_fmt = (tvin_trans_fmt_t)data.readInt32();
            int he_value = data.readInt32();
            int hs_value = data.readInt32();
            int ve_value = data.readInt32();
            int vs_value = data.readInt32();
            int result = factorySetOverscan(source_input_param, he_value, hs_value, ve_value, vs_value);
            reply->writeInt32(result);
            return NO_ERROR;
        }
        case FACTORY_GET_OVERSCAN: {
            CHECK_INTERFACE(ISystemControlService, data, reply);
            source_input_param_t source_input_param;
            source_input_param.source_input = (tv_source_input_t)data.readInt32();
            source_input_param.source_type = (tv_source_input_type_t)data.readInt32();
            ...
            source_input_param.trans_fmt = (tvin_trans_fmt_t)data.readInt32();
            int id = data.readInt32();;
            int result = factoryGetOverscan(source_input_param, id);
            reply->writeInt32(result);
            return NO_ERROR;
        }
        case FACTORY_SET_NOLINEPARAMS: {
            CHECK_INTERFACE(ISystemControlService, data, reply);
            source_input_param_t source_input_param;
            source_input_param.source_input = (tv_source_input_t)data.readInt32();
            source_input_param.source_type = (tv_source_input_type_t)data.readInt32();
            ...
            int osd0_value = data.readInt32();
            int osd25_value = data.readInt32();
            int osd50_value = data.readInt32();
            int osd75_value = data.readInt32();
            int osd100_value = data.readInt32();
            int result = factorySetNolineParams(source_input_param, type, osd0_value, osd25_value,
                                                osd50_value, osd75_value, osd100_value);
            reply->writeInt32(result);
            return NO_ERROR;
        }
        case FACTORY_GET_NOLINEPARAMS: {
            CHECK_INTERFACE(ISystemControlService, data, reply);
            source_input_param_t source_input_param;
            source_input_param.source_input = (tv_source_input_t)data.readInt32();
            source_input_param.source_type = (tv_source_input_type_t)data.readInt32();
            ...
            int type = data.readInt32();
            int id = data.readInt32();
            int result = factoryGetNolineParams(source_input_param, type, id);
            reply->writeInt32(result);
            return NO_ERROR;
        }
        case FACTORY_RSET_PARAMS: {
            CHECK_INTERFACE(ISystemControlService, data, reply);
            int result = factorySetParamsDefault();
            reply->writeInt32(result);
            return NO_ERROR;
        }
        case FACTORY_SSM_RESTORE: {
            CHECK_INTERFACE(ISystemControlService, data, reply);
            int result = factorySSMRestore();
            reply->writeInt32(result);
            return NO_ERROR;
        }
        case FACTORY_RESET_NOLINEAR: {
            CHECK_INTERFACE(ISystemControlService, data, reply);
            int result = factoryResetNonlinear();
            reply->writeInt32(result);
            return NO_ERROR;
        }
        case FACTORY_SET_GAMMA: {
            CHECK_INTERFACE(ISystemControlService, data, reply);
            int gamma_r= data.readInt32();
            int gamma_g = data.readInt32();
            int gamma_b = data.readInt32();
            int result = factorySetGamma(gamma_r, gamma_g, gamma_b);
            reply->writeInt32(result);
            return NO_ERROR;
        }
        case SSMREADNTYPES: {
            CHECK_INTERFACE(ISystemControlService, data, reply);
            int id = data.readInt32();
            int data_len = data.readInt32();
            int offset = data.readInt32();
            int result = sysSSMReadNTypes(id, data_len, offset);
            reply->writeInt32(result);
            return NO_ERROR;
        }
        case SSMWRITENTYPES: {
            ...
            int id = data.readInt32();
            int data_len = data.readInt32();
            int data_buf = data.readInt32();
            int offset = data.readInt32();
            int result = sysSSMWriteNTypes(id, data_len, data_buf, offset);
            reply->writeInt32(result);
            return NO_ERROR;
        }
        case SSM_GET_ADDR: {
        ...
        case SSM_GET_SIZE: {
            CHECK_INTERFACE(ISystemControlService, data, reply);
            int id = data.readInt32();
            int result = getActualSize(id);
            reply->writeInt32(result);
            return NO_ERROR;
        }
        case SSM_RECOVERY: {
            CHECK_INTERFACE(ISystemControlService, data, reply);
            int result = SSMRecovery();
            reply->writeInt32(result);
            return NO_ERROR;
        }
        case SET_PLLVALUES: {
            ...
            source_input_param.source_port = (tvin_port_t)data.readInt32();
            source_input_param.sig_fmt = (tvin_sig_fmt_t)data.readInt32();
            int result = setPLLValues(source_input_param);
            reply->writeInt32(result);
            return NO_ERROR;
        }
        case SET_CVD2VALUES: {
            ...
            source_input_param.source_port = (tvin_port_t)data.readInt32();
            source_input_param.sig_fmt = (tvin_sig_fmt_t)data.readInt32();
            int result = setCVD2Values(source_input_param);
            reply->writeInt32(result);
            return NO_ERROR;
        ...
        case SET_PQ_CONFIG: {
            CHECK_INTERFACE(ISystemControlService, data, reply);
            Set_Flag_Cmd_t id = (Set_Flag_Cmd_t)data.readInt32();
            int value = data.readInt32();
            int result = setPQConfig(id, value);
            reply->writeInt32(result);
            return NO_ERROR;
        }
        case GET_SSM_STATUS: {
            CHECK_INTERFACE(ISystemControlService, data, reply);
            int result = getSSMStatus();
            reply->writeInt32(result);
            return NO_ERROR;
        }
        case RESET_LAST_SOURCE: {
            CHECK_INTERFACE(ISystemControlService, data, reply);
            int result = resetLastPQSettingsSourceType();
            reply->writeInt32(result);
            return NO_ERROR;
        }
        case SET_CUR_SOURCE_INFO: {
            CHECK_INTERFACE(ISystemControlService, data, reply);
            source_input_param_t source_input_param;
            source_input_param.source_input = (tv_source_input_t)data.readInt32();
            source_input_param.source_type = (tv_source_input_type_t)data.readInt32();
            ...
            source_input_param.is3d = (is_3d_type_t)data.readInt32();
            source_input_param.trans_fmt = (tvin_trans_fmt_t)data.readInt32();
            int result = setCurrentSourceInfo(source_input_param);
            reply->writeInt32(result);
            return NO_ERROR;
        }
        case GET_AUTOSWITCHPCMODEFLAG: {
            CHECK_INTERFACE(ISystemControlService, data, reply);
            int result = getAutoSwitchPCModeFlag();
            reply->writeInt32(result);
            return NO_ERROR;
        }
