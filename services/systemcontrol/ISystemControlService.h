...
public:
    ...
    //PQ
    virtual int loadPQSettings(source_input_param_t source_input_param) = 0;
    virtual int loadCpqLdimRegs(void) = 0;
    virtual int setPQmode(int pq_mode, int is_save, int is_autoswitch) = 0;
    virtual int getPQmode(void) = 0;
    virtual int savePQmode(int pq_mode) = 0;
    virtual int setColorTemperature(int temp_mode, int is_save) = 0;
    virtual int getColorTemperature(void) = 0;
    virtual int saveColorTemperature(int temp_mode) = 0;
    virtual int setColorTemperatureParam(int Tempmode, tcon_rgb_ogo_t params) = 0;
    virtual int getColorTemperatureParam(int Tempmode, int id) = 0;
    virtual int saveColorTemperatureParam(int Tempmode, tcon_rgb_ogo_t params) = 0;
    virtual int setBrightness(int value, int is_save) = 0;
    virtual int getBrightness(void) = 0;
    virtual int saveBrightness(int value) = 0;
    virtual int setContrast(int value, int is_save ) = 0;
    virtual int getContrast(void) = 0;
    virtual int saveContrast(int value) = 0;
    virtual int setSaturation(int value, int is_save)= 0;
    virtual int getSaturation(void)= 0;
    virtual int saveSaturation(int value) = 0;
    virtual int setHue(int value, int is_save )= 0;
    virtual int getHue(void)= 0;
    virtual int saveHue(int value)= 0;
    virtual int setSharpness(int value, int is_enable, int is_save)= 0;
    virtual int getSharpness(void)= 0;
    virtual int saveSharpness(int value)= 0;
    virtual int setNoiseReductionMode(int nr_mode, int is_save)= 0;
    virtual int getNoiseReductionMode(void)= 0;
    virtual int saveNoiseReductionMode(int nr_mode)= 0;
    virtual int setGammaValue(int gamma_curve, int is_save) = 0;
    virtual int getGammaValue(void) = 0;

    virtual int factoryResetPQMode(void) = 0;
    virtual int factoryResetColorTemp(void) = 0;
    virtual int factorySetPQParam(source_input_param_t source_input_param, int pq_mode, int id, int value) = 0;
    virtual int factoryGetPQParam(source_input_param_t source_input_param, int pq_mode, int id) = 0;
    virtual int factorySetColorTemperatureParam(int colortemperature_mode, int id, int value) = 0;
    virtual int factoryGetColorTemperatureParam(int colortemperature_mode, int id) = 0;
    virtual int factorySaveColorTemperatureParam(int colortemperature_mode, int id, int value) = 0;
    virtual int factorySetOverscan(source_input_param_t source_input_param, int he_value, int hs_value, int ve_value, int vs_value) = 0;
    virtual int factoryGetOverscan(source_input_param_t source_input_param, int id) = 0;
    virtual int factorySetNolineParams(source_input_param_t source_input_param, int type, int osd0_value, int osd25_value,
                                                int osd50_value, int osd75_value, int osd100_value) = 0;
    virtual int factoryGetNolineParams(source_input_param_t source_input_param, int type, int id) = 0;
    virtual int factorySetParamsDefault(void) = 0;
    virtual int factorySSMRestore(void) = 0;
    virtual int factoryResetNonlinear(void) = 0;
    virtual int factorySetGamma(int gamma_r, int gamma_g, int gamma_b) = 0;
    virtual int sysSSMReadNTypes(int id, int data_len, int offset) = 0;
    virtual int sysSSMWriteNTypes(int id, int data_len, int data_buf, int offset) = 0;
    virtual int getActualAddr(int id) = 0;
    virtual int getActualSize(int id) = 0;
    virtual int SSMRecovery(void) = 0;
    virtual int setPLLValues(source_input_param_t source_input_param) = 0;
    virtual int setCVD2Values(source_input_param_t source_input_param) = 0;
    virtual int setPQConfig(Set_Flag_Cmd_t id, int value) = 0;
    virtual int getSSMStatus(void) = 0;
    virtual int resetLastPQSettingsSourceType(void) = 0;
    virtual int setCurrentSourceInfo(source_input_param_t source_input_param) = 0;
    virtual int getAutoSwitchPCModeFlag(void) = 0;
    //PQ end
