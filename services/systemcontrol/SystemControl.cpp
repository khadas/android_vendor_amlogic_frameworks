...
//PQ
int SystemControl::loadPQSettings(source_input_param_t source_input_param)
{
    return pCPQControl->LoadPQSettings(source_input_param);
}

int SystemControl::loadCpqLdimRegs(void)
{
    return pCPQControl->LoadCpqLdimRegs();
}

int SystemControl::sysSSMReadNTypes(int id, int data_len, int offset)
{
    return pCPQControl->Cpq_SSMReadNTypes(id, data_len, offset);
}

int SystemControl::sysSSMWriteNTypes(int id, int data_len, int data_buf, int offset)
{
    return pCPQControl->Cpq_SSMWriteNTypes(id, data_len, data_buf, offset);
}

int SystemControl::getActualAddr(int id)
{
    return pCPQControl->Cpq_GetSSMActualAddr(id);
}

int SystemControl::getActualSize(int id)
{
    return pCPQControl->Cpq_GetSSMActualSize(id);
}

int SystemControl::getSSMStatus(void)
{
    return pCPQControl->Cpq_GetSSMStatus();
}

int SystemControl::setPQmode(int pq_mode, int is_save, int is_autoswitch)
{
    return pCPQControl->SetPQMode(pq_mode, is_save, is_autoswitch);
}

int SystemControl::getPQmode(void)
{
    return (int)pCPQControl->GetPQMode();
}

int SystemControl::savePQmode(int pq_mode)
{
    return pCPQControl->SavePQMode(pq_mode);
}

int SystemControl::setColorTemperature(int temp_mode, int is_save)
{
    return pCPQControl->SetColorTemperature(temp_mode, is_save);
}

int SystemControl::getColorTemperature(void)
{
    return pCPQControl->GetColorTemperature();
}

int SystemControl::saveColorTemperature(int temp_mode)
{
    return pCPQControl->SaveColorTemperature(temp_mode);
}

int SystemControl::setColorTemperatureParam(int Tempmode, tcon_rgb_ogo_t params)
{
    return pCPQControl->SetColorTemperatureParams((vpp_color_temperature_mode_t)Tempmode, params);
}

int SystemControl::getColorTemperatureParam(int Tempmode, int id)
{
...
int SystemControl::saveColorTemperatureParam(int Tempmode, tcon_rgb_ogo_t params)
{
    return pCPQControl->SaveColorTemperatureParams((vpp_color_temperature_mode_t)Tempmode, params);
}

int SystemControl::setBrightness(int value, int is_save)
{
    return pCPQControl->SetBrightness(value, is_save);
}

int SystemControl::getBrightness(void)
{
    return pCPQControl->GetBrightness();
}

int SystemControl::saveBrightness(int value)
{
    return pCPQControl->SaveBrightness(value);
}

int SystemControl::setContrast(int value, int is_save)
{
    return pCPQControl->SetContrast(value, is_save);
}

int SystemControl::getContrast(void)
{
    return pCPQControl->GetContrast();
}

int SystemControl::saveContrast(int value)
{
    return pCPQControl->SaveContrast(value);
}

int SystemControl::setSaturation(int value, int is_save)
{
    return pCPQControl->SetSaturation(value, is_save);
}

int SystemControl::getSaturation(void)
{
    return pCPQControl->GetSaturation();
}

int SystemControl::saveSaturation(int value)
{
    return pCPQControl->SaveSaturation(value);
}

int SystemControl::setHue(int value, int is_save )
{
    return pCPQControl->SetHue(value, is_save);
}

int SystemControl::getHue(void)
{
    return pCPQControl->GetHue();
}

int SystemControl::saveHue(int value)
{
    return pCPQControl->SaveHue(value);
}

int SystemControl::setSharpness(int value, int is_enable, int is_save)
{
    return pCPQControl->SetSharpness(value, is_enable, is_save);
}

int SystemControl::getSharpness(void)
{
    return pCPQControl->GetSharpness();
}

int SystemControl::saveSharpness(int value)
{
    return pCPQControl->SaveSharpness(value);
}

int SystemControl::setNoiseReductionMode(int nr_mode, int is_save)
{
    return pCPQControl->SetNoiseReductionMode(nr_mode, is_save);
}
int SystemControl::getNoiseReductionMode(void)
{
    return (int)pCPQControl->GetNoiseReductionMode();
}

int SystemControl::saveNoiseReductionMode(int nr_mode)
{
    return pCPQControl->SaveNoiseReductionMode(nr_mode);
}

int SystemControl::setEyeProtectionMode(int source_input, int enable, int is_save)
{
    return pCPQControl->SetEyeProtectionMode((tv_source_input_t)source_input, enable, is_save);
}

int SystemControl::getEyeProtectionMode(int source_input)
{
    return pCPQControl->GetEyeProtectionMode((tv_source_input_t)source_input);
}

int SystemControl::setGammaValue(int gamma_curve, int is_save)
{
    return pCPQControl->SetGammaValue((vpp_gamma_curve_t)gamma_curve, is_save);
}

int SystemControl::getGammaValue()
{
    return pCPQControl->GetGammaValue();
}

int SystemControl::setDisplayMode(int source_input, int display_mode, int is_save)
{
    return pCPQControl->SetDisplayMode((tv_source_input_t)source_input, (vpp_display_mode_t)display_mode, is_save);
}

int SystemControl::getDisplayMode(int source_input)
{
    return pCPQControl->GetDisplayMode((tv_source_input_t)source_input);
}

int SystemControl::saveDisplayMode(int source_input, int display_mode)
{
    return pCPQControl->SaveDisplayMode((tv_source_input_t)source_input, (vpp_display_mode_t)display_mode);
}

int SystemControl::factoryResetPQMode(void)
{
    return pCPQControl->FactoryResetPQMode();
}

int SystemControl::factoryResetColorTemp(void)
{
    return pCPQControl->FactoryResetColorTemp();
}

int SystemControl::factorySetPQParam(source_input_param_t source_input_param, int pq_mode, int id, int value)
{
    return pCPQControl->FactorySetPQParam(source_input_param, pq_mode, id, value);
}

int SystemControl::factoryGetPQParam(source_input_param_t source_input_param, int pq_mode, int id)
{
    return pCPQControl->FactoryGetPQParam(source_input_param, pq_mode, id);
}

int SystemControl::factorySetColorTemperatureParam(int colortemperature_mode, int id, int value)
{
    return pCPQControl->FactorySetColorTemperatureParam(colortemperature_mode, (pq_color_param_t)id, value);
}
int SystemControl::factoryGetColorTemperatureParam(int colortemperature_mode, int id)
{
    return pCPQControl->FactoryGetColorTemperatureParam(colortemperature_mode, (pq_color_param_t)id);
}
int SystemControl::factorySaveColorTemperatureParam(int colortemperature_mode, int id, int value)
{
    return pCPQControl->FactorySaveColorTemperatureParam(colortemperature_mode, (pq_color_param_t)id, value);
}

int SystemControl::factorySetOverscan(source_input_param_t source_input_param, int he_value, int hs_value,
...
int SystemControl::factoryGetOverscan(source_input_param_t source_input_param, int id)
{
    return pCPQControl->FactoryGetOverscanParam(source_input_param, (tvin_cutwin_param_t)id);
}

int SystemControl::factorySetNolineParams(source_input_param_t source_input_param, int type, int osd0_value, int osd25_value,
...
int SystemControl::factoryGetNolineParams(source_input_param_t source_input_param, int type, int id)
{
    return pCPQControl->FactoryGetNolineParams(source_input_param, type, (noline_params_ID_t)id);
}

int SystemControl::factorySetParamsDefault()
{
    return pCPQControl->FactorySetParamsDefault();
}

int SystemControl::factorySSMRestore(void)
{
    return pCPQControl->FcatorySSMRestore();
}

int SystemControl::factoryResetNonlinear(void)
{
    return pCPQControl->FactoryResetNonlinear();
}

int SystemControl::factorySetGamma(int gamma_r, int gamma_g, int gamma_b)
{
    return pCPQControl->FactorySetGamma(gamma_r, gamma_g, gamma_b);
}

int SystemControl::SSMRecovery(void)
{
    return pCPQControl->Cpq_SSMRecovery();
}

int SystemControl::setPLLValues(source_input_param_t source_input_param)
{
    return pCPQControl->SetPLLValues(source_input_param);
}

int SystemControl::setCVD2Values(source_input_param_t source_input_param)
{
    return pCPQControl->SetCVD2Values(source_input_param);
}

int SystemControl::setPQConfig(Set_Flag_Cmd_t id, int value)
{
    return pCPQControl->SetFlagByCfg(id, value);
}

int SystemControl::resetLastPQSettingsSourceType(void)
{
    return pCPQControl->resetLastSourceTypeSettings();
}

int SystemControl::setCurrentSourceInfo(source_input_param_t source_input_param)
{
    return pCPQControl->SetCurrentSourceInputInfo(source_input_param);
}

source_input_param_t SystemControl::getCurrentSourceInfo(void)
{
    return pCPQControl->GetCurrentSourceInputInfo();
}

int SystemControl::getAutoSwitchPCModeFlag(void)
{
