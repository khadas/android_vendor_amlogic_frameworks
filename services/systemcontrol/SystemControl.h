...
public:
    ...
    virtual int setEyeProtectionMode(int source_input, int enable, int is_save);
    virtual int getEyeProtectionMode(int source_input);
    virtual int setGammaValue(int gamma_curve, int is_save);
    virtual int getGammaValue();
    virtual int setDisplayMode(int source_input, int display_mode, int is_save);
    virtual int getDisplayMode(int source_input);
    virtual int saveDisplayMode(int source_input, int display_mode);
    ...
    virtual source_input_param_t getCurrentSourceInfo(void);
