...
class SystemControlHal : public ISystemControl, public SystemControlNotify {
  public:
    ...
    Return<int32_t> loadCpqLdimRegs(void) override;
    ...
    Return<int32_t> setColorTemperatureParam(int32_t mode, const TconRgbOgo& params) override;
    Return<int32_t> getColorTemperatureParam(int32_t mode, int32_t id) override;
    Return<int32_t> saveColorTemperatureParam(int32_t mode, const TconRgbOgo& params) override;
    ...
    Return<int32_t> setBacklight(int32_t inputSrc, int32_t value, int32_t isSave) override;
    Return<int32_t> getBacklight(int32_t inputSrc) override;
    Return<int32_t> saveBacklight(int32_t inputSrc, int32_t value) override;
    Return<int32_t> factoryResetPQMode(void) override;
    Return<int32_t> factoryResetColorTemp(void) override;
    Return<int32_t> factorySetPQParam(const SourceInputParam& srcInputParam, int32_t mode, int32_t id, int32_t value) override;
    Return<int32_t> factoryGetPQParam(const SourceInputParam& srcInputParam, int32_t mode, int32_t id) override;
    Return<int32_t> factorySetColorTemperatureParam(int32_t colortemperature_mode, int32_t id, int32_t value) override;
    Return<int32_t> factoryGetColorTemperatureParam(int32_t colortemperature_mode, int32_t id) override;
    Return<int32_t> factorySaveColorTemperatureParam(int32_t colortemperature_mode, int32_t id, int32_t value) override;
    Return<int32_t> factorySetOverscan(const SourceInputParam& srcInputParam, int32_t he_value, int32_t hs_value, int32_t ve_value, int32_t vs_value) override;
    Return<int32_t> factoryGetOverscan(const SourceInputParam& srcInputParam, int32_t id) override;
    Return<int32_t> factorySetNolineParams(const SourceInputParam& srcInputParam, int32_t type, int32_t osd0_value, int32_t osd25_value,
                                        int32_t osd50_value, int32_t osd75_value, int32_t osd100_value) override;
    Return<int32_t> factoryGetNolineParams(const SourceInputParam& srcInputParam, int32_t type, int32_t id) override;
    ...
    Return<int32_t> setCVD2Values(const SourceInputParam& srcInputParam) override;
    Return<int32_t> setPQConfig(int32_t id, int32_t value) override;
    Return<int32_t> getSSMStatus(void) override;
    Return<int32_t> resetLastPQSettingsSourceType(void) override;
    Return<int32_t> setCurrentSourceInfo(const SourceInputParam& srcInputParam) override;
